...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    //emailjs use kri h uski site pr gye phir baad m login wagereh kis service banayi template banya aur template m {{name}} likhne pde jo yaha name=  krke bhej rge h woh

    emailjs.sendForm('service_khw2jdr', 'template_vp72qru', e.target, 'ePi6SQicHy5aS2Ihr')
      .then((result) => {
